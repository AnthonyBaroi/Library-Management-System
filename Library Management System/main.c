...
struct book *initialize_lib(struct book *start)
{
    ...
    new_book1->next=NULL;
    start_lib=new_book1;
    strcpy(new_book1->name,"The Lion, the Witch and the Wardrobe");
    strcpy(new_book1->author,"C. S. Lewis");
    new_book1->id=101;
    ptr=new_book1;

    new_book2=(struct book*)malloc(sizeof(struct book));
    new_book2->next=NULL;
    strcpy(new_book2->name,"The Godfather");
    strcpy(new_book2->author,"Mario Puzo");
    new_book2->id=102;
    ptr->next=new_book2;
    ptr=new_book2;
    ...
    new_book4->next=NULL;
    strcpy(new_book4->name,"Game of Thrones");
    strcpy(new_book4->author,"George R. R. Martin");
    new_book4->id=104;
    ptr->next=new_book4;
    ptr=new_book4;
    ...
    new_book5->next=NULL;
    strcpy(new_book5->name,"Harry Potter");
    strcpy(new_book5->author," J. K. Rowling");
    new_book5->id=105;
    ptr->next=new_book5;
